...
# Slim-бинарник (только vless) кладёт приложение be3600 в /data (флеш)
# при установке: из /data он маппится постранично и не занимает tmpfs
# (в /tmp неупакованные 15 МБ жили бы в RAM целиком). Из сети ничего не
